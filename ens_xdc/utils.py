...
if TYPE_CHECKING:
    from web3_xdc import Web3 as _Web3  # noqa: F401
    from web3_xdc.providers import (  # noqa: F401
        BaseProvider,
    )
...
def Web3() -> Type['_Web3']:
    from web3_xdc import Web3 as Web3Main
    return Web3Main
...
def customize_web3(w3: '_Web3') -> '_Web3':
    from web3_xdc.middleware import make_stalecheck_middleware

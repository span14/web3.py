...
DEPRECATION_WARNING_MESSAGE = "The IBAN feature is deprecated and will be removed in v6"
...
def test_createIndirect(value, expected, web3):
    ...
    with pytest.warns(DeprecationWarning, match=DEPRECATION_WARNING_MESSAGE):

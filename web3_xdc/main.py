...
from web3_xdc._utils.decorators import (
    deprecated_for,
)
from web3_xdc._utils.empty import (
    empty,
)
from web3_xdc._utils.encoding import (
    hex_encode_abi_type,
    to_hex,
    to_json,
)
...
from web3_xdc.providers.rpc import (
    HTTPProvider,
)
from web3_xdc.providers.websocket import (
    WebsocketProvider,
)
from web3_xdc.testing import (
    Testing,
)
from web3_xdc.types import (  # noqa: F401
    Middleware,
    MiddlewareOnion,
    Wei,
)
...
if TYPE_CHECKING:
    from web3_xdc.pm import PM  # noqa: F401
...
class Web3:
    ...
    @property
    def api(self) -> str:
        from web3_xdc import __version__
        return __version__
    ...
    def enable_unstable_package_management_api(self) -> None:
        from web3_xdc.pm import PM  # noqa: F811
